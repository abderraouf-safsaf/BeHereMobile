...
public class RootActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enseignantEmailTextView = (TextView) header.findViewById(R.id.emailTextView);

        System.out.println("TextView 1 = " + enseignantEmailTextView + " + TextView 2 = " + enseignantEmailTextView);
    }
